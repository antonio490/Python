...
def main():
    ...
    if not listen and len(target) and port > 0:
        ...
        # so send CTRL-D if not sending input to stin
    ...
    # and drop a shell back depending on our line options above.
    if listen:
        server_loop()
...
def client_handler(client_socket):
    ...
    if len(upload_destination):
        ...
        try:
            ...
            # aknowledge that we wrote the file out
